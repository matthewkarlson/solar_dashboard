...
SUMMARY_PROMPT_TEMPLATE = """The data in the dataframe is described as follows:
{questions_and_answers}
create a {length_of_summary} summary of the data in the dataframe.
"""

CHAT_WITH_DATA_SCIENTIST_PROMPT = """You are a data scientist. You have been given a dataframe with the following metadata"""
